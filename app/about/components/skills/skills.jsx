...
const skillCategories = {
	...
	api: {
		...
		languages: [
			...
			{ name: "ASP.NET Core", highlight: false },
			{ name: "Spring Boot", highlight: true },
			{ name: "Spring Security", highlight: false },
			{ name: "Spring WebFlux", highlight: false },
			{ name: "Spring Batch", highlight: false },
			{ name: "Quarkus", highlight: false },
			...
			{ name: "OAuth 2.0", highlight: false },
	...
	infra: {
		...
		languages: [
			...
			{ name: "AWS SQS", highlight: false },
			{ name: "AWS Lambda", highlight: false },
